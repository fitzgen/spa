...
mod tests {
    ...
    fn identifier() {
        ...
        assert_eq!(parse_Identifier("abc_123_lala"),
    ...
    #[test]
    fn expression() {
        assert_eq!(parse_Expression("abc"),
        ...
        assert_eq!(parse_Expression("abc == 123"),
        ...
        assert_eq!(parse_Expression("123 * abc + 42"),
        ...
        assert_eq!(parse_Expression("(abc + 123) * -2"),
                   Ok(ast::Expression::Multiplication(Box::new([
                       ast::Expression::Addition(Box::new([
                           ast::Expression::Identifier(ast::Identifier("abc")),
                           ast::Expression::Integer(123)
                       ])),
                       ast::Expression::Negation(Box::new(
                           ast::Expression::Integer(2)
                       ))
                   ]))));
        assert_eq!(parse_Expression("foo(1, 2, 3)"),
                   Ok(ast::Expression::Call(ast::Identifier("foo"),
                                            vec![ast::Expression::Integer(1),
                                                 ast::Expression::Integer(2),
                                                 ast::Expression::Integer(3)])));
        assert_eq!(parse_Expression("(foo)(1, 2, 3)"),
                   Ok(ast::Expression::IndirectCall(Box::new(ast::Expression::Identifier(ast::Identifier("foo"))),
                                                    vec![ast::Expression::Integer(1),
                                                         ast::Expression::Integer(2),
                                                         ast::Expression::Integer(3)])));
        assert_eq!(parse_Expression("&v"),
                   Ok(ast::Expression::AddressOf(ast::Identifier("v"))));
        assert_eq!(parse_Expression("*v == *w"),
                   Ok(ast::Expression::Equal(Box::new([
    ...
    #[test]
    fn statement() {
        assert_eq!(parse_Statement("foo = bar;"),
                   Ok(ast::Statement::Assignment(ast::Identifier("foo"),
                                                 ast::Expression::Identifier(ast::Identifier("bar")))));
        assert_eq!(parse_Statement("*foo = bar;"),
                   Ok(ast::Statement::DerefAssignment(ast::Identifier("foo"),
                                                      ast::Expression::Identifier(ast::Identifier("bar")))));
        assert_eq!(parse_Statement("output 123;"),
                   Ok(ast::Statement::Output(ast::Expression::Integer(123))));
        assert_eq!(parse_Statement("if (1) { output 2; }"),
                   Ok(ast::Statement::If(
                       ast::Expression::Integer(1),
                       vec![ast::Statement::Output(ast::Expression::Integer(2))],
                       None)));
        assert_eq!(parse_Statement("if (1) { output 2; } else { output 3; }"),
                   Ok(ast::Statement::If(
                       ast::Expression::Integer(1),
                       vec![ast::Statement::Output(ast::Expression::Integer(2))],
                       Some(vec![ast::Statement::Output(ast::Expression::Integer(3))]))));
        assert_eq!(parse_Statement("while (input) { output 1; }"),
                   Ok(ast::Statement::While(ast::Expression::Input,
